...
rules: [/^(?:([ \t\r\n\f]+))/,/^(?:\/\*[^*]*\*+([^/*][^*]*\*+)*\/)/,/^(?:((\/\*[^*]*\*+([^/*][^*]*\*+)*)|(\/\*[^*]*(\*+[^/*][^*]*)*)))/,/^(?:<!--)/,/^(?:-->)/,/^(?:~=)/,/^(?:\|=)/,/^(?:\^=)/,/^(?:\$=)/,/^(?:\*=)/,/^(?:\|\|)/,/^(?:(("([ !#$%&'\(\)\*+,\-\.\/:;<=>\?@\[\\\]^_`\{\|\}~]|[a-zA-Z0-9])*")|('([ !#$%&"\(\)\*+,\-\.\/:;<=>\?@\[\\\]^_`\{\|\}~]|[a-zA-Z0-9])*')))/,/^(?:(("([^\n\r\f\\"]|\\(\n|\r\n|\r|\f)|((\\([0-9a-fA-F]){1,6}(\r\n|[ \t\r\n\f])?)|\\[^\r\n\f0-9a-fA-F]))*\\?)|('([^\n\r\f\\']|\\(\n|\r\n|\r|\f)|((\\([0-9a-fA-F]){1,6}(\r\n|[ \t\r\n\f])?)|\\[^\r\n\f0-9a-fA-F]))*\\?)))/,/^(?:url\((([ \t\r\n\f]+)?)(("([ !#$%&'\(\)\*+,\-\.\/:;<=>\?@\[\\\]^_`\{\|\}~]|[a-zA-Z0-9])*")|('([ !#$%&"\(\)\*+,\-\.\/:;<=>\?@\[\\\]^_`\{\|\}~]|[a-zA-Z0-9])*'))(([ \t\r\n\f]+)?)\))/,/^(?:url\((([ \t\r\n\f]+)?)(([a-zA-Z0-9]|[:\/\?#\[\]@]|[!$&'\*+,;=]|[%]|[\-\._~])*)(([ \t\r\n\f]+)?)\))/,/^(?:((url\((([ \t\r\n\f]+)?)([!#$%&*-\[\]-~]|([\240-\377])|((\\([0-9a-fA-F]){1,6}(\r\n|[ \t\r\n\f])?)|\\[^\r\n\f0-9a-fA-F]))*(([ \t\r\n\f]+)?))|(url\((([ \t\r\n\f]+)?)(("([ !#$%&'\(\)\*+,\-\.\/:;<=>\?@\[\\\]^_`\{\|\}~]|[a-zA-Z0-9])*")|('([ !#$%&"\(\)\*+,\-\.\/:;<=>\?@\[\\\]^_`\{\|\}~]|[a-zA-Z0-9])*'))(([ \t\r\n\f]+)?))|(url\((([ \t\r\n\f]+)?)(("([^\n\r\f\\"]|\\(\n|\r\n|\r|\f)|((\\([0-9a-fA-F]){1,6}(\r\n|[ \t\r\n\f])?)|\\[^\r\n\f0-9a-fA-F]))*\\?)|('([^\n\r\f\\']|\\(\n|\r\n|\r|\f)|((\\([0-9a-fA-F]){1,6}(\r\n|[ \t\r\n\f])?)|\\[^\r\n\f0-9a-fA-F]))*\\?)))))/,/^(?:!((([ \t\r\n\f]+)?)|(\/\*[^*]*\*+([^/*][^*]*\*+)*\/))*{I}{M}{P}{O}{R}{T}{A}{N}{T})/,/^(?:@{I}{M}{P}{O}{R}{T})/,/^(?:@{P}{A}{G}{E})/,/^(?:@{M}{E}{D}{I}{A})/,/^(?:@charset )/,/^(?:{U}\+([0-9a-fA-F?]{1,6}(-[0-9a-fA-F]{1,6})?))/,/^(?:only\b)/,/^(?:not\b)/,/^(?:and\b)/,/^(?:(-?([_a-zA-Z])([_a-zZ-Z0-9\-])*)\()/,/^(?:(-?([_a-zA-Z])([_a-zZ-Z0-9\-])*))/,/^(?:([\-_]([0-9a-fA-F])-([0-9a-fA-F])))/,/^(?:@(-?([_a-zA-Z])([_a-zZ-Z0-9\-])*))/,/^(?:#(([_a-zZ-Z0-9\-])+))/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+){E}{M})/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+){E}{X})/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+){P}{X})/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+){C}{M})/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+){M}{M})/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+){I}{N})/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+){P}{T})/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+){P}{C})/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+){D}{E}{G})/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+){R}{A}{D})/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+){G}{R}{A}{D})/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+){M}{S})/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+){S})/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+){H}{Z})/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+){K}{H}{Z})/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+)(-?([_a-zA-Z])([_a-zZ-Z0-9\-])*))/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+)%)/,/^(?:([0-9]+(\.[0-9]+)?|\.[0-9]+))/,/^(?:.)/],
